...
<head>
    ...
    <style>
        ...
        .report-tab {
            display: none; /* Initially hide all reports */
        }
...
<div class="main-nav">
    <ul>
        <li><a href="#" class="report-tab-link" data-tab="asn-report">Asn Report</a></li>
        <li><a href="#" class="report-tab-link" data-tab="po-report">Po Report</a></li>
        <li><a href="#" class="report-tab-link" data-tab="fixation-pending">Fixation Pending</a></li>
        <li><a href="#" class="report-tab-link" data-tab="pending-documents">Pending Documents Rep</a></li>
        <li><a href="#" class="report-tab-link" data-tab="advance-payment-pending">Advance Payment Pending</a></li>
        <li><a href="#" class="report-tab-link" data-tab="advance-paid-report">Advance Paid Report</a></li>
        <li><a href="#" class="report-tab-link" data-tab="pending-payments">Pending Payments</a></li>
        <li><a href="#" class="report-tab-link" data-tab="omc-metals-pending-payments">Omc/V Metals Pending Payments</a></li>
        <li><a href="#" class="report-tab-link" data-tab="pending-shipment">Pending Shipment</a></li>
        <li><a href="#" class="report-tab-link" data-tab="courier-pending-report">Courier Pending Report</a></li>
        <li><a href="#" class="report-tab-link" data-tab="sales-contract-pending">Sales Contract Pending</a></li>
        <li><a href="#" class="report-tab-link" data-tab="commission-report">Commission Report</a></li>
...
<div class="output" id="searchResultsContainer">
  <!-- Dynamic report content will be shown here -->
  <div id="asn-report" class="report-tab">
  ...
  <div id="po-report" class="report-tab">
  <div class="search-container">
  <div class="search-row">
    <select class="search-input" id="impexp"> 
  ...
  <!-- Add additional divs for each report as needed -->
</div>
...
$(document).ready(function() {
    $('.report-tab-link').click(function() {
        ...
        $('.report-tab-link').removeClass('active-tab');
        
        // Add active-tab class to clicked link
        $(this).addClass('active-tab');
        
        // Hide all report tabs
        $('.report-tab').hide();
        
        // Show the clicked report tab
        $('#' + tabId).show();
    });
});
</script>
